    ...
    <div class="row d-flex justify-content-start  h-100">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5 justify-content-start">
        <div class="card shadow-2-strong justify-content-start" style="border-radius: 1rem; width: 70rem;">
          ...
          <h1 class="mb-5">Employee Availability Details</h1>
            <hr class="my-4">
...
<table class="table table-striped table-bordered">
  ...
  <tbody>
    <tr>
    <?php if(!empty($emp_availability)):?>

    <?php foreach($emp_availability as $availability): 
        echo "<tr>";
        echo "<td>" . $availability->emp_name . "</td><td>". $availability->start_date . "</td><td>". $availability->end_date ."</td><td>". $availability->day ."</td><td>". $availability->time_in . "</td><td>". $availability->time_out ."</td>";
        echo "</tr>"
    ...
    <?php else:?>
    <h1>Sorry! No Availability Details Found</h1>
    <?php endif;?>
