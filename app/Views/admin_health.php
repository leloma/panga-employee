    ...
    <div class="row d-flex justify-content-start  h-100">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5 justify-content-start">
        <div class="card shadow-2-strong justify-content-start" style="border-radius: 1rem; width: 70rem;">
          ...
          <h1 class="mb-5">Employee Health And Safety Details</h1>
            <hr class="my-4">
...
<table class="table table-striped table-bordered">
  <thead>
    <tr>
      ...
      <th scope="col">Tasks Not To Be Performed</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    <?php if(!empty($healthdetails)):?>

    <?php foreach($healthdetails as $healthdetail): 
        echo "<tr>";
        echo "<td>" . $healthdetail->emp_name . "</td><td>". $healthdetail->health_issue . "</td><td>". $healthdetail->not_performed_task . "</td>";
        echo "</tr>"
    ...
    <?php else:?>
    <h1>Sorry! No health or safety issues Found</h1>
    <?php endif;?>
